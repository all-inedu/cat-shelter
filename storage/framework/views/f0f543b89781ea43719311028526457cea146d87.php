                            ...
                            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                                ...
                                <div class="offcanvas-body">
                                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                        ...
                                        <li class="nav-item mx-md-3 mx-0 ">
                                            <a class="nav-link <?php echo e(request()->is('cats') ? 'active' : ''); ?>"
                                                href="/cats">Cats</a>
                                        </li>
                                        <li class="nav-item mx-md-3 mx-0 ">
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dl6\OneDrive\Documents\Project\cat-shelter\resources\views/template/home/main.blade.php ENDPATH**/ ?>