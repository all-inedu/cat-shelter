            ...
            <div class="col-auto col-md-3 col-xl-2 ps-sm-2 px-0">
                <div
                    ...
                    <ul class="nav nav-pills flex-column  mb-0 align-items-center align-items-sm-start w-100"
                        id="menu">
                        <li class="{{ request()->is('admin/dashboard') ? 'nav-item' : '' }}">
                        ...
                        <li class="{{ request()->is('admin/blog*') ? 'nav-item' : '' }}">
                            <a href="{{ url('admin/blog') }}" class="nav-link px-0 align-middle">
                                <i class="fs-5 bi-sticky"></i> <span class="ms-1 d-none d-sm-inline">Blog Post</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('admin/cat*') ? 'nav-item' : '' }}">
                            <a href="{{ url('admin/cat') }}" class="nav-link px-0 align-middle">
                                <i class="fs-5 bi-card-list"></i> <span class="ms-1 d-none d-sm-inline">Cat List</span></a>
                        </li>
                        <li class="{{ request()->is('admin/shelter*') ? 'nav-item' : '' }}">
                            <a href="{{ url('admin/shelter') }}" class="nav-link px-0 align-middle ">
                                <i class="fs-5 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Shelter
                                    List</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('admin/adopter*') ? 'nav-item' : '' }}">
                            <a href="{{ url('admin/adopter') }}" class="nav-link px-0 align-middle">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100"
                        id="menu">
                        <li class="{{ request()->is('admin/logout') ? 'nav-item' : '' }}">
